...
#' \code{\link{separate_date_rp5}}. Рекомендуется сначала выполнить агрегацию до суточного разрешения,
#' предварительно обработав пропуски, а затем агрегировать до месячного или годового разрешения.
#'
#'
